...
- ⚡ **Обработка в реальном времени** - фреймы по 320 сэмплов (20 мс)
...
### Для пользователей
- **Готовые бинарники** доступны в [Releases](../../releases) для всех платформ
...
- 🐳 **Рекомендуется**: Используйте GitHub Actions или Docker
...
- 📋 **Issues**: [GitHub Issues](../../issues) для баг-репортов
- 💡 **Предложения**: [GitHub Discussions](../../discussions) для идей  
- 📖 **Документация**: [Wiki](../../wiki) с подробными гайдами (если доступно)
